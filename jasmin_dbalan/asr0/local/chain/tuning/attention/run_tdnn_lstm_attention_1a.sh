...
# this line is from egs/tedlium/s5_r2/local/chain/tuning/run_tdnn_lstm_attention_1a.sh 
...
#common_egs_dir=/tudelft.net/staff-bulk/ewi/insy/SpeechLab/siyuanfeng/software/kaldi/egs/cgn/s5_vl_only/exp/chain/tdnn_lstm1a_sp_bi_epoch1_ld5/egs
common_egs_dir=/tudelft.net/staff-bulk/ewi/insy/SpeechLab/siyuanfeng/software/kaldi/egs/cgn/s5/exp/chain/tdnn_lstm_attend1a_sp_bi_epoch2_ld5/egs
chunk_width=150
...
dir=exp/chain${nnet3_affix}/tdnn_lstm_attend${tdnn_lstm_affix}_sp_bi_epoch${num_epochs}
...
if [ $stage -le 17 ]; then
  ...
  # We comment the line below since we replace this lstm layer with attention layer.
