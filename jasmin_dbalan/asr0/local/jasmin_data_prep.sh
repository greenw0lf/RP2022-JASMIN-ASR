...
for l in $lang; do
    ...
    python3 $base/local/jasmin_create_transcripts_segments.py ${jasmin}/data/annot/text/ort . 'q' $l
    ...
    python3 $base/local/jasmin_create_transcripts_segments.py ${jasmin}/data/annot/text/ort . 'p' $l
